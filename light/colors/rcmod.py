...
def set_palette(name, n_colors=6, desat=None):
    ...
    @param name: hls | husl | matplotlib colormap | seaborn color palette
        Palette definition. Should be something that :func:`color_palette`
        can process.
    @param n_colors: C{int} number of colors in the cycle.
    @param desat: C{float} factor to desaturate each color by.
    """
