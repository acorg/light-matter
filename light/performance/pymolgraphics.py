...
def makeLegend(features):
    ...
    colors = [[0.5, 1.0, 1.0], [1.0, 0.7, 0.2], [0.73, 0.55, 0.52],
              [0.6, 0.6, 0.1], [1.0, 0.5, 0.5], [0.1, 0.6, 0.6],
              ...
              [1.000000000, 0.819607843, 0.137254902], [0.2, 0.6, 0.2],
              [0.5, 0.5, 1.0], [0.3, 0.3, 1.0], [1.0, 0.5, 1.0],
              [0.819607843, 0.000000000, 0.309803922],
              [0.090196078, 0.329411765, 0.529411765],
              [1.000000000, 0.501960784, 0.000000000], [1.0, 1.0, 1.0]]
