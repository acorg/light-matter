...
class TestAlphaHelix(TestCase):
    ...
    def testHelixTwoRepeats(self):
        ...
        landmark = AlphaHelix()
        result = list(landmark.find(read))
        self.assertEqual([Landmark('A', 0, 2)], result)
    ...
    def testHelixTwoRepeatsWithNonZeroOffset(self):
        ...
        landmark = AlphaHelix()
        result = list(landmark.find(read))
        self.assertEqual([Landmark('A', 3, 2)], result)
    ...
    def testHelixThreeRepeats(self):
        ...
        landmark = AlphaHelix()
        result = list(landmark.find(read))
        self.assertEqual([Landmark('A', 0, 3)], result)
    ...
    def testTwoHelices(self):
        ...
        landmark = AlphaHelix()
        result = list(landmark.find(read))
        self.assertEqual([Landmark('A', 0, 2), Landmark('A', 31, 3)], result)
